    ...
    <v-card variant="outlined">
      <v-card-text>
        <div class="d-flex align-center">
          <h4 class="text-h4 mt-1">Top 5 Sales</h4>
          <div class="ml-auto">
          ...
          <div class="pa-5">
            <div class="d-flex align-start justify-space-between">
              <div>
                ...
                <span class="text-subtitle-2 text-medium-emphasis font-weight-bold"> {{ topProducts[0]?.brand }} </span>
              </div>
        ...
        <div class="mt-4">
          <perfect-scrollbar :style="{ maxHeight: 'calc(60vh - 300px)' }">
            <v-list lines="two" class="py-0">
              <v-list-item v-for="(item, i) in topProducts.slice(1)" :key="i" color="secondary" rounded="sm">
                ...
                <div class="d-inline-flex align-center justify-space-between w-100">
                  <div>
                    ...
                    <span :class="item.total_sold > 10 ? 'text-success' : 'text-error'"> {{ item.brand }} </span>
                  </div>
